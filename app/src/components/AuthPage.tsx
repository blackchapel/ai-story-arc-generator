...
// ── AuthPage ──────────────────────────────────────────────────────────────────
// Rendered as an overlay — parent mounts/unmounts it. No routing.

export interface AuthPageProps {
  /** Called after close animation ends — parent should unmount */
  onClose: () => void;
  /** Called immediately when auth succeeds, before close animation */
  onSuccess?: () => void;
}
