        ...
        >
          ...
          >
            {loading ? (
              <>
                <Spinner />
                <span>{isIOSPWA ? "Sending code…" : "Sending link…"}</span>
              </>
            ) : isIOSPWA ? (
              "Send code"
            ) : (
      ...
      >
        ...
        <div className="mt-6 w-full max-w-[360px] px-6">
          ...
          <p className="mt-2 text-[15px] leading-relaxed text-[#8C8C8C]">
            ...
            <span className="font-semibold text-[#0C0C0C]">{email}</span>. Enter
            it below to sign in.
          </p>
        </div>
        <div
        ...
        >
          <input
            ...
            style={{
              borderColor: error && step === "otp" ? "#EF4444" : "#EBEBEB",
              transition: "border-color 0.2s, box-shadow 0.2s",
              letterSpacing: otpCode ? "0.3em" : undefined,
            }}
            onFocus={(e) => {
              e.currentTarget.style.borderColor = "#6366F1";
              e.currentTarget.style.boxShadow =
          ...
          {error && step === "otp" && (
            <p
              id="otp-error"
              className="mt-2 text-center text-[13px] text-[#EF4444]"
              role="alert"
            >
              {error}
            </p>
