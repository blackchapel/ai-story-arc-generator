...
export const NEWS_ARTICLES: NewsArticle1[] = [
  {
    id: "1",
    category: "Technology",
    title:
      "OpenAI unveils next-gen reasoning model with human-level science benchmarks",
    description:
      "The new model outperforms PhD-level researchers on biology, chemistry, and physics tests.",
  ...
  },
  {
    ...
    description:
      "Major indices soared after CPI came in well below forecasts, reigniting rate-cut hopes.",
  ...
  },
  {
    ...
    description:
      "The giant rocket achieved all objectives and landed intact, a landmark for deep-space travel.",
  ...
  },
  {
    ...
    category: "Politics",
    title:
      "G7 leaders sign landmark international agreement on AI safety rules",
    description:
      "The binding framework sets global standards for frontier AI deployment for the first time.",
  ...
  },
  {
    ...
    category: "Sports",
    title:
      "India clinches ICC Champions Trophy in last-ball thriller against Australia",
    description:
      "Rohit Sharma's side held nerves to seal a 2-wicket win with one delivery remaining.",
  ...
  },
  {
    ...
    category: "Health",
    title:
      "Novel immunotherapy shows 94% remission rate in Phase 3 cancer trial",
    description:
      "The treatment targets multiple cancer types simultaneously with fewer side effects than chemo.",
  ...
  },
  {
    ...
    category: "Business",
    title:
      "Apple's Q2 earnings smash forecasts driven by record services revenue",
    description:
      "Services hit $26B as Apple Intelligence features drove a surge in subscription upgrades.",
