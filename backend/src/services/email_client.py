...
def send_otp_email(to_email: str, otp_code: str) -> None:
    """Call the email microservice to send a one-time sign-in code.
    ...
    try:
        response = httpx.post(
            f"{_EMAIL_SERVICE_URL}/send-otp",
            json={"to_email": to_email, "otp_code": otp_code},
        ...
        raise HTTPException(
            ...
            detail="Failed to send sign-in code. Please try again.",
        ) from exc
